<template>
  <div class="foot-btn" >
    <ul>
      <router-link tag="li" class="home" active-class="home--active" to="/home"><a href="javascript:;" ></a></router-link>
      <router-link tag="li" class="write" active-class="write--active" to="/buycar"><a href="javascript:;" ></a></router-link>
      <router-link tag="li" class="my" active-class="my--active" to="/user"><a href="javascript:;" ></a></router-link>
...
.foot-btn ul .write{width:0.82rem;height:0.81rem; background:url(../assets/img/buycar.png) no-repeat 0 0; background-size:100%; margin-left:1.18rem;}
